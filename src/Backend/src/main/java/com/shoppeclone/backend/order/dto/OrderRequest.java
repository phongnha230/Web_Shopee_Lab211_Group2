...
public class OrderRequest {
    ...
    private String shopVoucherCode; // Voucher riêng của Shop
    /** For Buy Now mode - direct items instead of cart */
    private List<OrderItemRequest> items;

    // Explicit getters/setters (Lombok may not generate when annotation processor
    // is off)
    public String getShippingProviderId() {
        return shippingProviderId;
    }

    public void setShippingProviderId(String v) {
        this.shippingProviderId = v;
    }
    ...
    public void setShippingAddress(ShippingAddressRequest v) {
    ...
    public void setShippingVoucherCode(String v) {
        this.shippingVoucherCode = v;
    }

    public String getShopVoucherCode() {
        return shopVoucherCode;
    }

    public void setShopVoucherCode(String v) {
        this.shopVoucherCode = v;
    }
    ...
    public void setVariantIds(List<String> v) {
        this.variantIds = v;
    }
    ...
    public void setItems(List<OrderItemRequest> v) {
        this.items = v;
    }
}
